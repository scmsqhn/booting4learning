...
get_ipython().magic('cd zean/')
get_ipython().magic('ls ')
get_ipython().magic('cd bond_risk/')
get_ipython().magic('ls ')
get_ipython().magic('pwd ')
get_ipython().magic('pwd ')
get_ipython().magic('ls ')
get_ipython().magic('run bond_fault_ana_1218.py')
get_ipython().magic('cd /')
get_ipython().magic('cd /site-packages/')
get_ipython().magic('ls ')
get_ipython().magic('pwd ')
get_ipython().magic('cd bond_risk')
get_ipython().magic('ls ')
...
get_ipython().magic('hist [1]')
get_ipython().magic('hist [:]')
get_ipython().magic('hist []')
get_ipython().magic('hist')
get_ipython().magic('logstat')
get_ipython().magic('logstart')
get_ipython().magic('load bond_fault_ana_1218.py')
# %load bond_fault_ana_1218.py
'''
function:
description:
'''
...
#        self.public_sentiment_df = md.wash_data_public_sentiment(self.public_sentiment_df)
        ...
        # 常规评级、穆迪评级，量化为分数
        mudy_level = {"Aaa":100,"Aa1":95,"Aa2":90,"Aa3":85,"A1":80,"A2":75,"A3":70,"Baa1":65,"Baa2":60,                     "Baa3":55, "Ba1":50,"Ba2":45,"Ba3":40,"B1":35,"B2":30,"B3":25,"Caa1":20,"Caa2":15,                     "Caa3":10,"Ca":5,"C":0}
        norm_level = {"AAA":100,"AA+":95,"AA":90,"AA-":85,"A+":80,"A":75,"A-":70,"BBB+":65,"BBB":60,                     "BBB-":55, "BB+":50,"BB":45,"BB-":40,"B+":35,"B":30,"B-":25,"CCC":20,"CC":15,                     "C":10, "RD":5,"D":0}
...
#        print(company['成立日期'])        
        ...
        company = company.drop(['公司中文简介', '信用评级说明', '法人代表', '总经理',                     '董事会秘书', '主页', '电子邮箱', '经营范围', '对象ID', '公司ID',                     '公司中文名称', '主要产品及业务', '办公地址', '评级展望', '债券主体公司id',                     '前次信用评级', '评级变动方向', '城市'], axis=1)
...
md.get_file()
pd
get_ipython().magic('run bon_risk/bond_fault_ana_1218.py')
get_ipython().magic('pwd ')
get_ipython().magic('run ./bond_fault_ana_1218.py')
get_ipython().magic('run ./bond_fault_ana_1218.py')
get_ipython().magic('run ./bond_fault_ana_1218.py')
...
get_ipython().magic('cd bond_risk/')
get_ipython().magic('ls ')
get_ipython().magic('cd data_wash/')
get_ipython().magic('ls ')
get_ipython().magic('pwd ')
get_ipython().magic('run ./bond_fault_ana_1218.py')
get_ipython().magic('run ./bond_fault_ana_1218.py')
...
get_ipython().magic('run bond_fault_ana_1218.py')
get_ipython().magic('run bond_fault_ana_1218.py')
get_ipython().magic('cd /home/zean/bond_risk/data_wash/')
get_ipython().magic('ls ')
get_ipython().magic('run bond_fault_ana_1218.py')
get_ipython().magic('cd /home/zean/bond_risk/')
get_ipython().magic('ls ')
get_ipython().magic('run bond_fault_ana_1218.py')
get_ipython().magic('run bond_fault_ana_1218.py')
get_ipython().magic('run bond_fault_ana_1218.py')
